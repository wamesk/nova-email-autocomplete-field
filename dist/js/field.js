...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    keyUp: function keyUp(event) {
      ...
      var count = this.countAtSymbols(this.value);
      if (count >= 2) {
        this.suggestions = [];
        return;
      }
      ...
      if (count === 1) {
        var partDomain = this.value.split('@')[1];
    ...
    selectSuggested: function selectSuggested(index) {
      var suggestion = this.suggestions[index];
      this.value = suggestion ? suggestion.value : this.value;
    },
    countAtSymbols: function countAtSymbols(string) {
      var matches = string.match(/@/g);
      return matches ? matches.length : 0;
    },
    getSuggestions: function getSuggestions(string, hasAtSymbol) {
    ...
    changeFocusState: function changeFocusState(focused) {
      var _this = this;
    ...
    checkUnique: function checkUnique() {
      var _this$currentField$un,
        _this2 = this;
      if (this.value === '') {
        return;
      }
      this.unique.status = 'loading';
      var data = this.currentField.unique;
      data.unique_resource = (_this$currentField$un = this.currentField.unique_resource) !== null && _this$currentField$un !== void 0 ? _this$currentField$un : null;
      ...
      axios__WEBPACK_IMPORTED_MODULE_1__["default"].post('/email-check-exists', data).then(function (response) {
        _this2.unique = response.data;
      })["catch"](function (error) {
        _this2.unique.status = 'error';
      });
    }
  }
});
    ...
    field: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
        ...
        onKeyup: _cache[1] || (_cache[1] = function () {
          return $options.keyUp && $options.keyUp.apply($options, arguments);
        }),
        onKeydown: _cache[2] || (_cache[2] = function () {
          return $options.keyDown && $options.keyDown.apply($options, arguments);
        }),
        onFocus: _cache[3] || (_cache[3] = function ($event) {
          return $options.changeFocusState(true);
        }),
        onBlur: _cache[4] || (_cache[4] = function ($event) {
          return $options.changeFocusState(false);
        })
      }, null, 42 /* CLASS, PROPS, NEED_HYDRATION */, _hoisted_2), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, _ctx.value]]), $data.suggestions.length && $data.focused ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_3, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.suggestions, function (suggestion, index) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
          "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["w-full px-3 py-1.5 cursor-pointer text-gray-500 dark:text-gray-400 border-gray-100 dark:border-gray-700", index === $data.selectedIndex ? 'bg-primary-500 text-white' : 'hover:bg-gray-100 dark:hover:bg-gray-800']),
          key: suggestion,
          onClick: function onClick($event) {
            return $options.handleSuggestionClick(index);
          }
        }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(suggestion.value), 11 /* TEXT, CLASS, PROPS */, _hoisted_4);
      }), 128 /* KEYED_FRAGMENT */))])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $data.unique.enabled ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_5, [$data.unique.status === 'loading' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_6, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Loader, {
        width: "20",
        "class": "ml-1 mr-2"
      }), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.__('nova-email-autocomplete-field.loading')), 1 /* TEXT */)])) : $data.unique.status === 'valid' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_7, [_cache[5] || (_cache[5] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("svg", {
      ...
      })], -1 /* HOISTED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.__($data.unique.message)), 1 /* TEXT */)])) : $data.unique.status === 'invalid' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_8, [_cache[6] || (_cache[6] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("svg", {
        xmlns: "http://www.w3.org/2000/svg",
        fill: "none",
        viewBox: "0 0 24 24",
        stroke: "currentColor",
      ...
      })], -1 /* HOISTED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.__($data.unique.message)) + " ", 1 /* TEXT */), $data.unique.url && _ctx.currentField.unique_resource !== false ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("a", {
        key: 0,
        href: $data.unique.url,
        "class": "link-default component-inertia-link"
      }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.__('nova-email-autocomplete-field.view')), 9 /* TEXT, PROPS */, _hoisted_9)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])) : $data.unique.status === 'error' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_10, [_cache[7] || (_cache[7] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("svg", {
        xmlns: "http://www.w3.org/2000/svg",
        fill: "none",
        viewBox: "0 0 24 24",
        stroke: "currentColor",
        ...
        "stroke-width": "2",
        d: "M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"
      })], -1 /* HOISTED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.__('nova-email-autocomplete-field.error')), 1 /* TEXT */)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])];
    }),
    _: 1 /* STABLE */
...
Nova.booting(function (app, store) {
  app.component('index-nova-email-autocomplete-field', _components_IndexField__WEBPACK_IMPORTED_MODULE_0__["default"]);
  app.component('detail-nova-email-autocomplete-field', _components_DetailField__WEBPACK_IMPORTED_MODULE_1__["default"]);
  app.component('form-nova-email-autocomplete-field', _components_FormField__WEBPACK_IMPORTED_MODULE_2__["default"]);
});
...
/* harmony import */ var _Users_sucho_WAME_Laravel_laravel_skeleton_vendor_wamesk_nova_email_autocomplete_field_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,_Users_sucho_WAME_Laravel_laravel_skeleton_vendor_wamesk_nova_email_autocomplete_field_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_DetailField_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_DetailField_vue_vue_type_template_id_0224618e__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/DetailField.vue"]])
/* hot reload */
if (false) {}
...
/* harmony import */ var _Users_sucho_WAME_Laravel_laravel_skeleton_vendor_wamesk_nova_email_autocomplete_field_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkwame_nova_email_autocomplete_field"] = self["webpackChunkwame_nova_email_autocomplete_field"] || [];
